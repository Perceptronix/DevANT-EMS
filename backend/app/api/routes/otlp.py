...
async def ingest_otlp(request: Request, background_tasks: BackgroundTasks):
    ...
    if resolved_project_id and parsed_records:
        ...
        if persisted_count > 0:
            # Schedule clustering pipeline in background to keep ingest fast and resilient.
            background_tasks.add_task(_run_pipeline_background, normalized_records, resolved_project_id)
